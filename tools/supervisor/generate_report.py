...
def generate_student_report(student_id: str) -> bytes:
    ...
    # Header
    elements.append(h("EyeQ — Student Report", size=16, color=BRAND, bold=True))
    ...
    elements.append(Spacer(1, 0.2 * cm))
    elements.append(h("Generated by EyeQ · Singapore National Eye Centre · Confidential", size=8, color=MUTED))
