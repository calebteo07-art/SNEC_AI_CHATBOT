...
export const AVATAR_AXES = {
  ...
  mouth: ["smile", "grin", "soft", "open", "smirk", "ooh", "tongue", "laugh", "catSmile", "chomp", "whistle", "pout", "shocked", "evilGrin"],
  blush: ["none", "rose", "coral", "peach", "plum", "berry", "sky", "mint", "gold", "grape", "teal", "stars", "freckles"],
  glasses: ["none", "round", "square", "catEye", "monocle", "reading", "goggles", "heart", "visor", "dealWithIt", "cinema3d", "ski", "star", "magnifier", "steampunk", "broken"],
