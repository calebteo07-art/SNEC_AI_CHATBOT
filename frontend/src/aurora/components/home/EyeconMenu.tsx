...
export function EyeconMenu() {
  ...
  // Re-editing is free now (client-composited Eyecon, no paid render), so EVERYONE — students
  // included — gets the "Edit Eyecon" entry point to remix their look anytime.
