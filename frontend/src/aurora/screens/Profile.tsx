    ...
    <div className="aurora-profile-screen">
      <section className="aurora-card aurora-profile-card">
        <div className="aurora-profile-id">
          <span className="aurora-profile-avatar-lg aurora-flow" data-eyecon={eyeconConfig ? "" : undefined}>
            {eyeconConfig ? <Eyecon portraitUrl={eyeconPortraitUrl} config={eyeconConfig} size={62} /> : initials}
          </span>
